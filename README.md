...
| Software      | Jetson AGX Orin | Jetson NX | Neousys NRU-120S (AGX Xavier) |
| ------------- |:---------------:|:---------------:|:-----------------------------:|
| Jetpack       | 5.0.2           | 5.1 | 4.6.1 |
| L4T           | 35.1.1          | 35.2.1 | 32.7.1 |
| CUDA          | 11.4            | 11.4.315 | 10.2.300 |
| cuDNN         | 8.4.1.50	      | 8.6.0.166 | 8.2.1.32 |
| libtensorflow | 2.11.0		      | 2.11.0 | 2.4.x |
| Node-RED	    | 3.0.2	          | 3.1.7 | 3.0.2 |
| Node.js       | 18.12.1         | 20.11.1 | 16.19.0 |
| tfjs-node-gpu | 4.2.0	          | 4.17.0 | 4.2.0 |
| Python        | 3.8.10          | 3.8.10  | 3.6.9 |
...
```
wget https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.11-jetson-5.3-7.2-8.7.tar.gz
```
...
```
wget https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.4-jetson-5.3-7.2-no-tensorrt.tar.gz
```
...
![alt text](
https://github.com/Lapland-UAS-Tequ/tequ-jetson-nodered-tensorflow/blob/main/images/example-nodered-flow.JPG "Example flow")
...
| ------------- |:-----------------:|:--------:|:------:|:-------:|:----:|:-----------------:|:---------:|:-------------:|:--------:|
| 2.11          | Jetson AGX Orin   | 5.0.2    | 3.8.10 | 18.12.1 |  yes | 5.3 7.2 8.7       | yes       | 4.2.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2-11-jetson-cpu.tar.gz">link</a>     |
| 2.11          | Jetson AGX Orin   | 5.0.2    | 3.8.10 | 18.12.1 |  -   |  -                | -         | 4.2.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.11-jetson-5.3-7.2-8.7.tar.gz">link</a>     |
| 2.4           | Jetson AGX Xavier | 4.6.1    | 3.6.9  | 16.19.0 |  yes |  5.3 7.2          | -         | 4.2.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.4-jetson-5.3-7.2-no-tensorrt.tar.gz">link</a>     |
| 2.4           | Jetson AGX Xavier | 4.6.1    | 3.6.9  | 16.19.0 |  no  |  -                | -         | 4.2.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.4-jetson-cpu.tar.gz">link</a>     |
| 2.3           | Jetson AGX Xavier | 4.6.1    | 3.6.9  | 16.19.0 |  yes |  5.3 7.2          | -         | 3.3.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.3-jetson-5.3-7.2-no-tensorrt.tar.gz">link</a>     |
| 2.3           | Jetson AGX Xavier | 4.6.1    | 3.6.9  | 16.19.0 |  no  |  -                | -         | 3.3.0         | <a href="https://tequ-files.s3.eu.cloud-object-storage.appdomain.cloud/libtensorflow-2.3-jetson-cpu.tar.gz">link</a>     |
